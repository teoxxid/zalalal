...
urlpatterns = [
    ...
    path(
        ...
        views.api_service_detail,
        name="api_service_detail",
    ),
    path(
        "api/order/add/<int:service_id>/",
        views.api_add_to_order,
        name="api_add_to_order",
    ),
    path(
        "api/order/item/<int:order_item_id>/",
        views.api_update_order_item,
